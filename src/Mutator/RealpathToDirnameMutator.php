...
/**
 * Mengganti pemanggilan fungsi global realpath($x) -> dirname($x)
 */
final class RealpathToDirnameMutator implements Mutator
{
    ...
    public static function getDefinition(): Definition
    {
        return new Definition(
            <<<'TXT'
Replaces global function call realpath($arg) with dirname($arg).
TXT,
